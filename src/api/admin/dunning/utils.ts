...
export function normalizeAdminDunningCasesListQuery(
  ...
  const normalized: ListAdminDunningCasesInput = {
    ...
    payment_provider_id: query.payment_provider_id,
    last_payment_error_code: query.last_payment_error_code,
    attempt_count_min: query.attempt_count_min,
    attempt_count_max: query.attempt_count_max,
